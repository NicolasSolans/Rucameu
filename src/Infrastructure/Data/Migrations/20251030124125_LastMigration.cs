    ...
    public partial class LastMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemCarts", x => new { x.CartId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Message = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DateConsult = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CartId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Roldán", new DateTime(2025, 10, 30, 9, 41, 23, 390, DateTimeKind.Local).AddTicks(4511), "Admin", "lucapisso4@gmail.com", "Pisso", "Luca", "luca1234", "3416932072", "Admin" },
                    { 2, null, "Rosario, centro", new DateTime(2025, 10, 30, 9, 41, 23, 390, DateTimeKind.Local).AddTicks(4539), "Admin", "nico.solans.drc@gmail.com", "Solans", "Nicolas", "nicolas1234", "3412173325", "Admin" },
                    { 3, null, "Rosario, zona oeste", new DateTime(2025, 10, 30, 9, 41, 23, 390, DateTimeKind.Local).AddTicks(4544), "Admin", "lucasgluppi@gmail.com", "Luppi", "Lucas", "lucas1234", "3412707429", "Admin" }
                });
